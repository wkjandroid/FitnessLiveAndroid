                        ...
                        case MotionEvent.ACTION_UP:
                            if (!isCancel) {
                                ...
                                if (mProgress < 10) {
                                    ...
                                    Toast.makeText(TakeVideoActivity.this, "时间太短", Toast.LENGTH_SHORT).show();
                                    stopView(false);
                                    break;
                                }
                                //停止录制
                                Toast.makeText(TakeVideoActivity.this, "停止录制", Toast.LENGTH_SHORT).show();
                                mediaUtils.stopRecordSave();
                                stopView(true);
                            } else {
                                //现在是取消状态,不保存
                                mediaUtils.stopRecordUnSave();
                                Toast.makeText(TakeVideoActivity.this, "取消保存", Toast.LENGTH_SHORT).show();
                                stopView(false);
                            }
                            ret = false;
                            break;
